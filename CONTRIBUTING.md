...
[Panflute internals](#panfluteinternals)
...
- `elements.py`: have all the standard Pandoc elements (`Str`, `Para`, `Space`, etc.). Pandoc elements have one of three base classes (`Block`, `Inline` and `Metadata`)
